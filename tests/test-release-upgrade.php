...
if(!preg_match("/Version:\s*0\.3\.1/",$main))throw new RuntimeException('Plugin header must declare 0.3.1.');
if(!str_contains($main,"define('XSOFTY_WP_MCP_VERSION', '0.3.1')"))throw new RuntimeException('Runtime version must declare 0.3.1.');
